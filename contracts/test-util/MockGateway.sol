...
import { IAxelarAuth } from './deps/IAxelarAuth.sol';
import { IBurnableMintableCappedERC20 } from './deps/IBurnableMintableCappedERC20.sol';
import { ITokenDeployer } from './deps/ITokenDeployer.sol';

import { ECDSA } from './deps/ECDSA.sol';
import { DepositHandler } from './deps/DepositHandler.sol';
import { EternalStorage } from './deps/EternalStorage.sol';

/**
 * @title MockAxelarGateway Contract
 * @notice This is a modified version of Axelar's Gateway Contract to be used for unit testing the Ojo contract. It updates
 * the validateContractCall to return true for all calls for the purpose of generated execute msgs by the Ojo unit test.
 */
contract MockAxelarGateway is IAxelarGateway, Implementation, EternalStorage {
    ...
    /**
     * @notice Constructs the MockAxelarGateway contract.
